...
Public Class student_delete
    ...
    Private Sub student_delete_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            cn.Open()
            cm.Connection = cn
            da = New MySqlDataAdapter("select * from student_details where roll_no='" & student_delete1.ComboBox1.SelectedItem & "' ", cn)
            ds = New Data.DataSet
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        cm.CommandText = "DELETE FROM `student_details` WHERE roll_no ='" & TextBox1.Text & "'  "
